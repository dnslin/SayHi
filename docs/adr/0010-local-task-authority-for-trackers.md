...
The SayHi Task Projection and Event stream are the workflow state authority. GitHub, GitLab, local Markdown, and custom trackers are collaboration projections connected through typed references and explicit status, pull, push, and conflict-resolution plans; closing an external Issue cannot complete a local Task.
